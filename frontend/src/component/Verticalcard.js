...

                {
                    ...
                    loading ? (
                        ...
                        data.map((product, index) => {
                            return (
                                <Link to={"/product/"+product?._id} key={index} className='w-full min-w-[280px] md:min-w-[280px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow' onClick={scrollTop}>
